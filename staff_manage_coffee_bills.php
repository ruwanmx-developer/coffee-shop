...
<head>
    <title>Manage Coffee Bills</title>
...
<body id="staff">
    ...
    <div class="container f-sec">
        <div class="row pt-5">
            <div class="col-12">
                <h3 class="mb-3 page-title">View Pending Coffee Bills</h3>
                <div class="row">
                    <div class="col">
            ...
            <div class="col-12 mt-4">
                <h3 class="mb-3 page-title">View Completed Coffee Bills</h3>
                <div class="row">
                    <div class="col">
                        <table class="table table-dark table-striped">
                            <thead>
                            ...
                            <tbody>
                                <?php 
                            $sql = "SELECT * FROM orders WHERE type=1 AND status=1";
                            $result = $__conn->query($sql);
                            if ($result->num_rows > 0) {
                                $count = 1;
                                while($row = $result->fetch_assoc()) {
